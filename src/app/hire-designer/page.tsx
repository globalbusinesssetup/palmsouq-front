...
const projectTypes = [
  ...
  { title: 'Poster & Banner', value: 'poster&banner' },
  { title: 'T-Shirts & Apparel', value: 't-shirts&apparel' },
  { title: 'Re-Artworking', value: 're-artworking' },
  { title: 'Other’s', value: 'other’s' },
];
                ...
                <div className="mt-10">
                  ...
                  <ul className="pl-4 list-disc list-outside">
                    <li className="text-xs text-neutral-500 mt-2">
                      Upload any visuals, images, or samples that reflect your
                      desired aesthetic, style or creative direction for the
                      project.
                    </li>
                  </ul>
                </div>
