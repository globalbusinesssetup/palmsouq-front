...
const steps = [
  { title: 'Shipping Method', icon: <TbTruckDelivery size={26} /> },
  { title: 'Payment', icon: <TbTruckDelivery size={26} /> },
  { title: 'Confirmation', icon: <IoCardOutline size={26} /> },
];
...
const Checkout = () => {
  ...
  return (
    <main className="bg-neutral-50 py-10">
      <div className="container mx-auto flex flex-row gap-x-6">
        <div className="flex-1 max-w-[920px] mx-auto px-10 py-8 border rounded-xl border-neutral-300 bg-white">
          <div className="flex items-center justify-between gap-x-5 pb-6 border-b border-neutral-200">
            {steps.map((step, i) => (
              <Step
                key={`step_${i}`}
                index={i}
          ...
          {currentStep === 0 ? (
            <>
              <div className="mt-8">
                ...
                <div className="mt-6 flex gap-x-4">
                  <RadioGroup
                    ...
                    className={
                      'flex-1 max-w-[calc(50%-16px)] flex items-center gap-4'
                    }
                  >
                  ...
                  <button className="flex-1 border border-neutral-300 hover:border-primary/40 duration-300 transition-all rounded-lg flex flex-col items-center justify-center">
                    <div className="">
              ...
              <div className="mt-8">
                ...
                <RadioGroup
                  ...
                  aria-label="Server size"
                  className={'grid grid-cols-3 items-center gap-4 mt-6'}
                >
                  {deliveryOptions.map((opt) => (
                    <Field
                      key={opt.value}
                      className={`flex-1 gap-2 p-4 border rounded-lg transition-all duration-300 cursor-pointer ${
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-x-6 max-w-[506px]">
            ...
            <div className="flex flex-col items-center justify-center ">
              ...
              <h3 className="text-2xl font-semibold text-neutral-700 mt-6">
                Order Confirmed!
              </h3>
              ...
              <Button
                ...
                className="py-0 h-11 w-[336px] font-semibold mt-8 flex items-center justify-center gap-x-2"
              >
                Go to My Order&apos;s{' '}
                <IoIosArrowRoundForward className="text-2xl" />
              </Button>
              <Link href="/" className="mt-4 text-neutral-500">
                Continue to Home
              </Link>
            </div>
          )}
          {currentStep !== steps.length - 1 && (
            <div className="flex items-center justify-between mt-5">
              ...
              >
                <IoIosArrowRoundBack className="text-2xl" /> Back to Cart
              </button>
              <Button
                disabled={currentStep === 2}
                onClick={() => setStep((prev) => prev + 1)}
                className="flex items-center justify-center gap-x-2 w-[227px]"
              >
                {currentStep === 0 ? (
                  <>
                    Continue to Payment
        ...
        {currentStep !== steps.length - 1 && (
          <div className="w-[336px] h-fit py-4 px-6 border rounded-xl border-neutral-300 bg-white">
            <h5 className="text-black font-semibold pb-4">Order Summery</h5>
            <div className="mt-4 space-y-6 pb-6 border-b border-neutral-200">
              <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between pt-3.5">
              ...
              <h4 className="text-lg font-bold text-primary">315.00 AED</h4>
            </div>
          </div>
        )}
      </div>
