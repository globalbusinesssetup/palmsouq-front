            ...
            {Array(2)
              ...
              .map((_, i) => (
                <tr key={`table_${i}`} className="border-b border-neutral-200">
                  ...
                  <td className="py-4 text-neutral-500">300.00 AED</td>
                  ...
                  <td className="py-4 text-neutral-500 text-sm">123456</td>
                  <td className="py-4 text-neutral-500 text-sm">654321</td>
                  <td className="py-4">
                    <Tag status="success" />
                  </td>
                </tr>
