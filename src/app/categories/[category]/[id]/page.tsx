      ...
      <main className="container mx-auto mt-8 bg-[#FCFCFD]">
        <div className="p-6 border border-neutral-200 bg-white rounded-xl flex gap-x-8">
          <div className="w-5/12">
            ...
            <div className="mt-4 py-[18px] flex items-center justify-center gap-x-4 border border-neutral-100 bg-neutral-100 rounded-lg">
              {features.slice(1).map((feature, i) => (
                <div key={`feature_${i}`} className="flex items-center gap-x-3">
                  <div className="w-[33px] h-[33px] rounded-full flex items-center justify-center bg-neutral-50">
                    <Image
                      src={feature.icon}
                      width={42}
                      height={42}
                  ...
                  <div className="">
                    <h6 className="text-[10px] leading-[17px] font-semibold text-neutral-700">
                      {feature.title}
                    </h6>
          ...
          <div className="flex-1">
            <p className="font-medium text-success">Business Card</p>
            <h2 className="text-2xl text-black font-semibold mt-1">
              350 Gsm Matt Lamination
            </h2>
            <div className="flex-1 flex items-center gap-x-3 py-4 border-b border-[#E6E6E6]">
            ...
            <div className="flex items-end justify-between pt-8 pb-4">
              <div className="">
                ...
                <div className="flex items-center gap-x-3.5 px-4 py-3.5 border border-[#D0D5DD] rounded-lg mt-2">
                  <button
                    disabled={quantity === 1}
                    onClick={() => handleQuantity('minus')}
                    className="w-7 h-7 flex items-center justify-center rounded bg-neutral-100"
                  >
                    <FiMinus />
                  </button>
                  <input
                    ...
                    type="number"
                    className="w-11 focus-visible:outline-none pb-1 border-b text-[#344054] no-number-input-appearance m-0 text-center"
                  />
                  <button
              ...
              <div className="px-6 py-2 rounded-lg bg-[#F8F9FC]">
                <h4 className="text-xl text-[#4E5BA6] font-bold">00 AED</h4>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              {packages.map((pkg, i) => (
                <button
                  ...
                  key={`pkg_${i}`}
                  className={`px-9 py-2.5 border rounded-lg text-left transition-all duration-300 ${
                    pkg.quantity === quantity
                      ? 'border-primary shadow-md shadow-[#0021690D] bg-neutral-50'
                      : 'border-[#D0D5DD]'
                  }`}
                >
                  <h6 className="text-sm font-semibold text-left text-primary">
                    {pkg.quantity}
                  </h6>
              ...
              <div className="mt-8">
                ...
                <div className="flex items-center gap-x-4 mt-2">
                  {paperStocks.map((stock, i) => (
                    <button
                      key={`stock_${i}`}
                      className="w-[126px] flex-1 h-12 rounded-lg text-sm font-semibold text-[#344054] border border-[#D0D5DD]"
                    >
                      {stock.label}
                    </button>
                  ))}
            ...
            <div className="mt-8">
              ...
              <div className="flex items-center justify-between mt-2">
                <div className="flex items-center gap-x-4">
                  {timelines.map((timeline, i) => (
                    <button
                      ...
                      className={`w-[126px] h-12 rounded-lg text-sm font-semibold text-[#344054] border transition-all duration-300  ${
                ...
                <div className="">
                  <button className="w-[136px] h-12 bg-neutral-100 rounded-lg text-sm font-semibold text-neutral-600">
                    Bothside
                  </button>
                </div>
              </div>
            </div>
            <div className="mt-8 px-4 py-3.5 border border-dashed border-neutral-400 rounded-[10px] flex items-center justify-between">
              <p className="text-sm text-neutral-600">
                Based on selection, your order will be ready within next
              </p>
              <span className="text-sm text-[#3F206A] font-medium py-1 px-3 bg-neutral-100 border rounded-full border-[#EAECF0]">
                24 Business Hours
              </span>
            </div>
        ...
        <div className="mt-8 pb-10">
          <Disclosure
            ...
            defaultOpen={false}
          >
            <DisclosureButton className="group w-full flex data-[open]:border-b items-center justify-between py-3 px-6 bg-white">
              <span className="text-xl text-neutral-800 font-semibold">
                Product Description
              </span>
              <div className="group-data-[open]:rotate-180 size-8 flex items-center justify-center rounded-full bg-neutral-100">
                <FaAngleDown className="text-base text-[#344054]" />
              </div>
            </DisclosureButton>
            <DisclosurePanel className="pt-5 text-base bg-white text-neutral-500 px-5 transition-all duration-0 pb-5">
